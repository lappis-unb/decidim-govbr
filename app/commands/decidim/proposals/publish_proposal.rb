...
module Decidim
  module Proposals
    ...
    class PublishProposal < Decidim::Command
      ...
      def create_previous_moderation
        return unless @proposal.component.settings.requires_previous_moderation?

        Moderation.create!(
          reportable: @proposal,
          participatory_space: @proposal.participatory_space,
          reported_content: @proposal.reported_searchable_content_text,
