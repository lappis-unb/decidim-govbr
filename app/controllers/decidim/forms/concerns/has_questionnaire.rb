      ...
      module HasQuestionnaire
        ...
        included do
          ...
          def visitor_can_answer?
            ...
            (current_user || allow_unregistered?) && (meeting.nil? || (meeting.decidim_author_id == current_user.id && meeting.finished?))
          end
          ...
          def visitor_already_answered?
            ...
            if meeting_id.present?
              questionnaire.answers.any? do |answer|
                answer.decidim_meetings_meeting_id.to_s == meeting_id
              end
            else
