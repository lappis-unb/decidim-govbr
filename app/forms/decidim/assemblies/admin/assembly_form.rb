    ...
    module Admin
      ...
      class AssemblyForm < Form
        ...
        def available_initial_page_components
          ...
          @available_initial_page_components ||= Decidim::Component.where(participatory_space_type: "Decidim::Assembly", participatory_space_id: id, manifest_name: ["pages", "homes"])
        end
