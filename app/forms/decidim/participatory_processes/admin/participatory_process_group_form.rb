  ...
  module ParticipatoryProcesses
    module Admin
      ...
      class ParticipatoryProcessGroupForm < Form
        ...
        attribute :decidim_area_id, Integer
        ...
        validates :area, presence: true, if: proc { |object| object.decidim_area_id.present? }
        ...
        def area
          @area ||= current_organization.areas.find_by(id: decidim_area_id)
        end
