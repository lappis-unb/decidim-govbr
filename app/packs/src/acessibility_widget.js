const acessibility_widget = (() => {
    ...
    return (
      t &&
        ...
        (n += (function (t) {
          ...
          if (t) {
            var n = function (n) {
              (o.includes(n) ? a : [""]).forEach(function (i) {
  ...
  function r(t) {
    ...
    r
      ...
      document.documentElement.classList.toggle(l, r);
  }
  var l = function () {
      return (
        (l =
    ...
    d = ["", "*:not(.material-icons,.asw-menu,.asw-menu *)"],
    g = [
      "h1",
      "h2",
      "h3",
    ...
    w = { lang: "pt", states: { fontSize: 1 }, updatedAt: new Date() },
    v = w,
    S = "asw";
  function b(t) {
    var e = f(f({}, v), {
      states: f(f({}, v.states), t),
      updatedAt: new Date(),
    });
    return y(e), e;
  }
  ...
  function C(t) {
    if ((void 0 === t && (t = !0), t)) return v;
    var e = A();
    return (v = e ? JSON.parse(e) : w);
  }
  function A() {
    return (function (t) {
      for (
  ...
  function G() {
    ...
    void 0 === (t = e["highlight-title"]) && (t = !1),
      r(z(z({}, k), { enable: t })),
      (function (t) {
        void 0 === t && (t = !1), r(j(j({}, R), { enable: t }));
      })(e["highlight-links"]),
      (function (t) {
        void 0 === t && (t = !1), r(D(D({}, M), { enable: t }));
      })(e["letter-spacing"]),
      (function (t) {
        void 0 === t && (t = !1), r(T(T({}, O), { enable: t }));
      })(e["line-height"]),
      (function (t) {
        void 0 === t && (t = !1), r(E(E({}, B), { enable: t }));
      })(e["font-weight"]),
      (function (t) {
        void 0 === t && (t = !1), r(p(p({}, m), { enable: t }));
      })(e["readable-font"]),
      (function (t) {
        void 0 === t && (t = !1);
      ...
      (function (t) {
        void 0 === t && (t = !1), r(l(l({}, c), { enable: t }));
      })(e["stop-animations"]),
      (function (t) {
        void 0 === t && (t = !1), r(F(F({}, L), { enable: t }));
      })(e["big-cursor"]),
      (function (t) {
        void 0 === t && (t = !1),
          t
    ...
    return (
      (function (a) {
        ...
        (c.innerHTML =
          ...
          null === (o = c.querySelector(".asw-menu-btn")) ||
            void 0 === o ||
              ...
              a.preventDefault(),
                r
                  ...
                  : (r = (function (a) {
                      ...
                      (d.innerHTML = e),
                        (d.querySelector(".asw-amount").innerText = "".concat(
                          100 *
                            (null !== (o = x("fontSize")) && void 0 !== o
                              ? o
                              : 1),
                          "%"
                        )),
                          ...
                          .forEach(function (t) {
                            t.addEventListener("click", function () {
                              ...
                              t.classList.contains("asw-minus")
                                ...
                                (i = Math.max(i, 0.1)),
                                (i = Math.min(i, 3)),
                                n((i = Number(i.toFixed(2)))),
                                b({ fontSize: i });
                            });
                          }),
                        d.querySelectorAll(".asw-btn").forEach(function (t) {
                          t.addEventListener("click", function () {
                            var e,
                              n,
                              a,
                              o,
                              r = t.dataset.key,
                              l = !t.classList.contains("asw-selected");
                            t.classList.contains("asw-filter")
                              ? (d
                                ...
                                b({ contrast: !!l && r }),
                                l && t.classList.add("asw-selected"),
                                (n = C().states.contrast),
                                (a = ""),
                                (o = P[n]) &&
                                  (a = s(
                                    I(I({}, o), { selector: "html.aws-filter" })
                                  )),
                                i({ css: a, id: "asw-filter-style" }),
                                document.documentElement.classList.toggle(
                                  "aws-filter",
                                  Boolean(n)
                                ))
                              : (t.classList.toggle("asw-selected", l),
                                b((((e = {})[r] = l), e)),
                                G());
                          });
                        }),
                        null === (r = d.querySelector(".asw-menu-reset")) ||
                          void 0 === r ||
                      ...
                      return u.appendChild(d), d;
                    })({ container: c }));
            });
        try {
          var u = A();
          u ? (y(JSON.parse(u)), N()) : y({ lang: "pt" });
        } catch (t) {}
        l.appendChild(c);
      })({ container: ot(ot({}, st), a).container }),
      {}
    );
  }
