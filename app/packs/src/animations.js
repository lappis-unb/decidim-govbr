document.addEventListener("DOMContentLoaded", function () {
  ...
  function showRulesCard() {
    ...
    showRulesCardButton.innerHTML = `<i class="fa-solid fa-info-circle" style="color: #333333;"></i> Esconder Regras`;
  }
  ...
  function hideRulesCard() {
    ...
    showRulesCardButton.innerHTML = `<i class="fa-solid fa-info-circle" style="color: #333333;"></i> Conheça os critérios para a seleção de proposta`;
  }
});
