...
*/
      ...
      /***/ "./src/components/cookiebar/cookiebar-templates.js": /***/ (
        ...
        class CookiebarTemplates {
          ...
          setGlobalContentArea() {
            return `<div class="br-modal">
              <div class="br-card" id="card0">
                <div class="br-container-fluid p-1 p-2xh">
          ...
          _setMainTitle() {
            return `<div class="br-modal-title">
              <div class="br-row">
                ...
                <div class="br-col-sm-auto order-first order-sm-last">
          ...
          _setMainContentHeader() {
            return `<div class="br-header">
              <div class="br-row justify-content-between flex-fill">
                <div class="br-col-12 br-col-sm align-self-center mb-2">
                  <div class="title">${this.labels.setCookieGroupsLabel()}</div>
                </div>
                <div class="br-col-12 align-self-center">
                  ${this.data.allOptOut ? this._setCheckAll() : ""}
                </div>
                <div class="br-col-12 text-sm-right message mt-1">
            ...
            this.data.cookieGroups.forEach((groupData, groupIndex) => {
              groupTemplates += `<hr>
                          <div class="br-item group-info">
                            <div class="br-row mb-1">
                              <div class="br-col-12 br-col-sm align-self-center order-4 order-sm-1">
                                ${this._setGroupName(groupData)}
                              </div>
                              <div class="br-col align-self-center order-1 order-sm-2">
                                ${
                                  groupData.groupOptOut
                              ...
                              <div class="br-col br-col-sm-auto align-self-center order-2 order-sm-3">
                                ${this._setGroupButton()}
                              </div>
                              <div class="br-col-12 br-col-sm-12 order-3 order-sm-4 text-sm-right message mt-1 mb-1">
            ...
            groupData.cookieList.forEach((cookieData, cookieIndex) => {
              cookieTemplates += `<div class="br-card">
                            <div class="card-content">
                              <div class="br-row mb-1">
                                <div class="br-col-12 text-right">
                                  ${
                                    cookieData.cookieOptOut
                                ...
                                <div class="br-col-12 message text-right mb-1 mt-1">
                              ...
                              <div class="br-row">
                                ...
                                <div class="br-col-12 br-col-sm mb-1 cookie-data">
      ...
      /***/ "./src/components/cookiebar/cookiebar.js": /***/ (
        ...
        /* harmony import */ var _partial_js_behavior_checkgroup__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__("./src/partial/js/behavior/checkgroup.js");
        /* harmony import */ var _cookiebar_data__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__("./src/components/cookiebar/cookiebar-data.js");
        /* harmony import */ var _cookiebar_templates__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            "./src/components/cookiebar/cookiebar-templates.js"
          );
        /* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__("./src/components/cookiebar/selectors.js");
        ...
        class BRCookiebar {
          ...
          constructor({
            ...
            this.component = component;
            this.data =
              new _cookiebar_data__WEBPACK_IMPORTED_MODULE_0__ /* .CookiebarData */.B(
                json,
                lang
              );
            this.templates =
              new _cookiebar_templates__WEBPACK_IMPORTED_MODULE_1__ /* .CookiebarTemplates */.y(
                this.data
              );
            this.mode = mode;
          ...
          _setAcceptButtonBehavior() {
            const acceptButton = this.component.querySelector(
              _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .ACCEPT_BUTTON */.Hw
            );
          ...
          _setPoliticsButtonBehavior() {
            this.component
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .POLITICS_BUTTON */.qB
              )
          ...
          _setCloseButtonBehavior() {
            this.component
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .CLOSE_BUTTON */.pw
              )
              .forEach((closeButton) => {
          ...
          _setWindowResizeBehavior() {
            window.addEventListener("resize", () => {
              ...
              this.component
                .querySelectorAll(
                  _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .ACTION_BUTTONS */.Al
                )
                .forEach((button) => {
          ...
          _setToggleGroupBehavior() {
            this.component
              .querySelectorAll(
                `${`${
                  _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .GROUP_BUTTON */._0
                }, ${
                  _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .GROUP_NAME */.jp
                }, ${
                  _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .COOKIES_CHECKED */.As
                }, ${
                  _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .GROUP_SIZE */.jy
                }`}`
              )
              .forEach((clickable) => {
          ...
          _handleToggleGroupClick(event) {
            ...
            if (element.classList.contains("open")) {
              ...
              element.nextElementSibling
                .querySelectorAll(
                  _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .BR_SWITCH */.qI
                )
                .forEach((check) => {
          ...
          _setCheckboxBehavior() {
            this.component
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .PARENT_CHECKBOX */.UI
              )
              .forEach((trigger) => {
                this.checkgroupBehavior =
                  new _partial_js_behavior_checkgroup__WEBPACK_IMPORTED_MODULE_3__[
                    "default"
                  ](trigger);
          ...
          _setSelectionBehavior() {
            this.component
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .CHECKBOX */.Bg
              )
              .forEach((checkbox) => {
          ...
          _displayBroadAlertMessage() {
            this.component
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .BROAD_ALERT */.hP
              )
              .forEach((broadAlert) => {
                if (
                  this.data.allAlertMessage &&
          ...
          _displayGroupAlertMessage(groupIndex) {
            const group = this.component.querySelectorAll(
              _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .GROUP_INFO */.eQ
            )[groupIndex];
            group
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .GROUP_ALERT */.qQ
              )
              .forEach((groupAlert) => {
                if (
          ...
          _displayCookieAlertMessage(groupIndex, cookieIndex) {
            ...
            cookie
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .COOKIE_ALERT */.cj
              )
              .forEach((cookieAlert) => {
                if (
          ...
          _toggleIcon(element, oldIcon, newIcon) {
            element
              .querySelectorAll(
                _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .BUTTON_ICON */.D2
              )
              .forEach((icon) => {
          ...
          _scrollUp(element) {
            setTimeout(() => {
              this.component
                .querySelectorAll(
                  _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .WRAPPER */.tB
                )
                .forEach(() => {
                  setTimeout(() => {
          ...
          _setOpenView() {
            ...
            const modalFooter = this.component.querySelector(
              _selectors__WEBPACK_IMPORTED_MODULE_2__ /* .MODAL_FOOTER */.dI
            );
      ...
      /***/ "./src/components/cookiebar/selectors.js": /***/ (
        ...
        const CONTAINER_FLUID = ".br-modal > .br-card .br-container-fluid";
        ...
        const BROAD_ALERT =
          ".header .br-row:nth-child(1) div:nth-child(3) .feedback";
        const GROUP_ALERT = ".br-row:nth-child(1) div:nth-child(4) .feedback";
        const COOKIE_ALERT = ".br-row:nth-child(1) div:nth-child(2) .feedback";
          ...
          _buildDateTimePicker() {
            ...
            switch (this.component.getAttribute("data-type")) {
              case "date":
                ...
                noCalendar = false;
                this._dateInputMask(
                  this.component.querySelectorAll("input")[0]
                );
                break;
      ...
      /***/ "./src/components/footer/footer.js": /***/ (
        ...
        class BRFooter {
          ...
          _showList(e) {
            ...
            parent = parent.classList.contains("br-col-2")
        ...
        class BRHeader {
          ...
          handleEvent(event) {
            const notificationElement =
              this.component.querySelector(".br-notification");
        ...
        class BRMenu {
          ...
          _toggleDropMenu(element) {
            ...
            if (!element.hasAttribute("data-click-listener")) {
              ...
              // Adiciona atributo especial para indicar que o elemento jÃ¡ possui click listener
          ...
          _notificationTooltip() {
            ...
            window.document
              ...
              .forEach((TooltipNotification) => {
                ...
                if (elementTooltip) {
                  texttooltip =
                    elementTooltip.getAttribute("data-tooltip-text");
      ...
      <div class="br-item not-found">
        <div class="br-container pl-0 pr-0">
          <div class="br-row">
            <div class="br-col-auto">
              <img src="${image}">
            </div>
    ...
    `;
          ...
          mountSelectedValues(input) {
            ...
            const maxCharacterCount =
              this.getMaxCharacterCountBeforeOverflow(input);
            this.amountE = amount;
            ...
            for (const element of array) {
              ...
              if (value.length >= maxCharacterCount) {
                ...
                contOverflow =
                  acountVisible === 0
                    ? array.length - 1
                    : array.length - acountVisible;
                posUltimoArray = contOverflow;
              } else {
                const tmpValue =
                  posicaoArray > 0 ? `, ${element}` : `${element}`;
                value += `${tmpValue}`;
                acountVisible++;
              }
            }
          ...
          filterArrayByInputSize(array, input) {
            ...
            const filteredArray = array.filter((element) => {
              ...
              if (getPixelSize(elementText) <= input.offsetWidth) {
                ...
                const truncatedText = `${elementText.substring(
                  0,
                  maxLength - 3
                )}...`;
      ...
      /***/ "./src/components/table/table.js": /***/ (
        ...
        class BRTable {
          ...
          /**
           * Configura a altura do cabeÃ§alho
           * @private
           */
          _getBRHeaderHeight() {
            ...
            this.component.addEventListener("keyup", () => {
              ...
              if (!this.characters) {
                if (characterCount === 0 && this.limit.innerHTML === "") {
                  this.limit.innerHTML = `Limite mÃ¡ximo de <strong>${this.maximum}</strong> caracteres`;
        ...
        class BRUpload {
          ...
          _handleFiles(files) {
            ...
            if (!this._inputElement.multiple && files.length > 1) {
              this._feedback(
                "danger",
                "Ã‰ permitido o envio de somente 1 arquivo."
              );
            } else if (
        ...
        const jsonData = `[
  {
    ...
    "selectAll": false,
    "allAlertMessage": "Ao desativar essa opÃ§Ã£o, sua navegaÃ§Ã£o ficarÃ¡ comprometida",
    "closeLabel": "fechar",
    ...
    "cookieGroups": [
      ...
      },
      {
        ...
        "groupOptOut": true,
        "groupSelected": false,
        "groupAlertMessage": "Ao desativar essa opÃ§Ã£o, sua navegaÃ§Ã£o ficarÃ¡ comprometida",
        "groupText": "Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum delectus fuga omnis, placeat harum id aliquam, blanditiis consectetur est cupiditate ipsam alias vitae veritatis beatae, aperiam totam assumenda. Sed, modi!",
        "cookieList": [
          {
    ...
    (() => {
      ...
      /* harmony default export */ const tooltip_tooltip = TooltipExample; // CONCATENATED MODULE: ./src/partial/js/core.behavior.js
