document.addEventListener("DOMContentLoaded", function () {
  ...
  const getPresentialMeetingContainer =
    document.getElementById("presential-meeting");
  const getOnlineMeetingContainer = document.getElementById(
    "location-hints-meeting"
  );
  ...
  if (urlVideoMeeting && iframeMeeting) {
  ...
  if (
    getMettingType &&
    getPresentialMeetingContainer &&
    getOnlineMeetingContainer
  ) {
