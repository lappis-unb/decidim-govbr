...
Rails.application.routes.draw do
  ...
  get 'admin/user_proposal_statistic_report_force_refresh/:slug',
      to: 'decidim/govbr/user_proposals_statistic_settings#force_refresh', as: 'user_proposal_statistic_report_force_refresh'
  get 'admin/user_proposal_statistic_report_create/:slug',
      to: 'decidim/govbr/user_proposals_statistic_settings#create', as: 'user_proposal_statistic_report_create'
  post 'admin/organization/homepage/edit', to: 'decidim/admin/organization_homepage#add_html_block',
                                           as: 'add_html_block'
end
