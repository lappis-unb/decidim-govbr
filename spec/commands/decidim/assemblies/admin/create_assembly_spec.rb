      ...
      describe CreateAssembly do
        ...
        let(:form) do
          instance_double(
            ...
            initial_page_component_id: 0,
            initial_page_type: "default"
          )
        end
        let(:invalid) { false }
        ...
        context "when everything is ok" do
          ...
          it "saves the initial page information" do
            subject.call

            expect(assembly.initial_page_component_id).to be_zero
            expect(assembly.initial_page_type).to eq("default")
          end
        end
      end
    end
