  ...
  module Forms
    describe AnswerQuestionnaire do
      ...
      describe "when the form is valid" do
        ...
        context "when topp agreement is not checked" do
          let(:topp_agreement) { "0" }
        ...
        context "when topp agreement is checked" do
          let(:topp_agreement) { "1" }

          it "creates anonymous answers" do
            command.call
            expect(Answer.all.all? { |ans| ans.anonymous_answer == false }).to be(true)
          end
        end
