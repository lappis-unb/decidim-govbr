  ...
  describe Admin::CopyParticipatoryProcess do
    ...
    context "when user belongs to process group" do
      ...
      it "pushes the duplicated process into the group" do
        expect(participatory_process.participatory_process_group).to be_nil
        expect { subject.call }.to broadcast(:ok)
        expect(duplicated_process.participatory_process_group).to eq(participatory_process_group)
      end
    end
    ...
    context "when user is admin" do
      ...
      it "does not create user role for them" do
        expect { subject.call }.not_to change(Decidim::ParticipatoryProcessUserRole, :count)
      end
    end
  end
end
