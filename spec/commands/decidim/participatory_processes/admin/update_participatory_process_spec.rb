  ...
  module ParticipatoryProcesses
    module Admin
      describe UpdateParticipatoryProcess do
        describe "call" do
          let(:my_process) { create :participatory_process, initial_page_component_id: 10, initial_page_type: "foo" }
          let(:params) do
            {
          ...
          describe "when the form is valid" do
            ...
            it "updates the initial page information" do
              expect { command.call }.to change { [my_process.reload.initial_page_component_id, my_process.reload.initial_page_type] }.from([10, "foo"]).to([initial_page_component_id, initial_page_type])
            end
          end
        end
      end
